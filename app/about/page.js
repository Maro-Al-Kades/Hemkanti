  ...
  return (
    ...
    <>
      <Head>
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-QJMTDGDNCL"></script>
        <script
      ...
      `,
        ...
        <meta property="og:url" content="https://www.hemkanti.care/about-us" />
        <link rel="canonical" href="https://www.hemkanti.care/about-us" />
      </Head>
      ...
      <section className="bg-gradient-to-r from-[#FFF5F3] via-[#FEE9E5] to-[#FFF5F3] py-20 px-6 relative overflow-hidden">
        ...
        <div className="text-center relative z-10 mb-16">
          <h2 className="text-6xl font-bold text-[#BF6159] glow-text mb-6">
        ...
        <div className="relative z-10 mb-20">
          <div className="flex flex-col lg:flex-row items-center gap-16 max-w-6xl mx-auto">
            ...
            <div className="lg:w-2/3">
              <h3 className="text-4xl font-semibold text-[#BF6159] mb-4">
                Dr. Akanksha Kharote
              </h3>
              ...
              <p className="text-gray-700 text-lg leading-relaxed mb-6">
                The founder of our brand, Dr. Akanksha has dedicated her entire
                career to the cosmetology and healthcare sector. After extensive
                work experiences in healthcare Sector, Dr. Akanksha established
                Hemkanti Brand with a sanskrit meaning Shining like a gold to
                provide Skin, Hair, Aesthetic Gynecology along with Homoeopathic
                treatments. Hemkanti Clinics has patients from various cities
                who have embarked to have their desired treatments from our top
                skin specialist’s team.
              </p>
              <p className="text-gray-700 text-lg leading-relaxed mb-8">
                We love what we do and therefore it reflects on you. Beauty is
                one of the key aspects of once confidence. The issue of
                confidence is very important in beauty, as in everything else.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-4xl mx-auto relative z-10 mb-16">
          {achievements.map((achievement, index) => (
            <div
              ...
              <div className="text-3xl font-bold text-[#BF6159] mb-2">
                {achievement.value}
              </div>
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          <h3 className="text-2xl font-semibold text-[#BF6159] mb-4">
            Our Promise
          </h3>
          <p className="text-gray-700 text-lg leading-relaxed">
            At Hemkanti Clinics, we're committed to helping you achieve your
            best skin health through a perfect blend of traditional wisdom and
            modern science. Every treatment is personalized to your unique
            needs, ensuring optimal results and lasting beauty.
          </p>
        </div>
